...
public class Ejercicio2Colegio {
	...
	public static void main(String[] args) {
		...
		int opcion = 0;
		do {
			String[] menu = { "\n1. Insertar Alumno por Aula", "2. Buscar Alumno", "3. Borrar Alumno",
					"4. Mostrar Alumnos por Aula ", "5. Mostrar Alumnos", "6. Mostrar plazas libres de todas las aulas",
					"7. Salir" };
			...
			switch (opcion) {
			case 1:
				gestionAlumnos(colegio, INSERTAR, "En que aula quieres meter al alumno");
				break;
			case 2:
				operarSobreAlumno(colegio, BUSQUEDA);
				break;
			case 3:
				operarSobreAlumno(colegio, BORRADO);
				break;
			case 4:
				gestionAlumnos(colegio, MOSTRAR, "De que aula quieres mostrar los alumnos");
				break;
			case 5:
				mostrarColegio(colegio, ALUMNOS);
				break;
			case 6:
				mostrarColegio(colegio, PLAZAS_LIBRES);
				break;
			case 7:
